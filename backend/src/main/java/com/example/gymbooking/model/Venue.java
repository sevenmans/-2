...
public class Venue {
    ...
    @Column(name = "auto_generate_days")
    private Integer autoGenerateDays = 7;
    ...
    public void setFacilityTags(List<String> facilityTags) {
        this.features = facilityTags;
        if (facilityTags == null || facilityTags.isEmpty()) {
            this.facilities = null;
        } else {
            this.facilities = String.join(",", facilityTags);
        }
    }
    ...
    public Integer getAutoGenerateDays() {
        return autoGenerateDays;
    }

    public void setAutoGenerateDays(Integer autoGenerateDays) {
        this.autoGenerateDays = autoGenerateDays;
    }
