...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    D: common_vendor.t($data.form.autoGenerateDays),
    E: $data.autoDaysOptions,
    F: common_vendor.o((...args) => $options.onAutoDaysChange && $options.onAutoDaysChange(...args)),
    G: common_vendor.t($data.saving ? "保存中..." : "保存"),
    H: $data.saving ? 1 : "",
